...
SCREENINGS = {
    ...
    # 내 머릿속의 군체 GV (5/29 용산 11관 19:30)
    "202605268450": [
        {"branch": "용산아이파크몰", "hall": "11관", "sessions": 1},  # 194
    ],
    # 호빵맨 개봉 주 무대인사
    "202605137940": [
    ...
    # 너바나 빠더너스 문상훈 추가 무대인사 (6/2 왕십리 18:40·20:55, 관 미명시)
    "202605218057": [
        {"branch": "왕십리", "hall": None, "sessions": 2},
    ],
    # 너바나 수입 비하인드 GV (5/30 14:40 CGV 강변, 관 미명시)
    "202605268354": [
        {"branch": "강변", "hall": None, "sessions": 1},
    ],
    # 상자 속의 양 프리미어 내한 무대인사 (6/5 CGV 왕십리 7관 18:35 + 5관 16:30)
    "202605278356": [
        {"branch": "왕십리", "hall": "7관", "sessions": 1},
        {"branch": "왕십리", "hall": "5관", "sessions": 1},
    ],
